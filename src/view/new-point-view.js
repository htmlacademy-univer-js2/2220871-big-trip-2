...
import { createTypesTemplate, createDestinationsOptionsTemplate } from './edit-point-view';
...
const createNewPointTemplate = (destinations, offersByType) => {
  const typesTemplate = createTypesTemplate(destinations, offersByType);
  const offersTemplate = createOffersTemplate(offersByType);
  return `
